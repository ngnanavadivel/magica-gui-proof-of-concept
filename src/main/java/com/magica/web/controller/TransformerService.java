...
public class TransformerService {
	...
	@RequestMapping(value = "services/transform", method = RequestMethod.POST, produces = {
	...
	public @ResponseBody String transform(@RequestParam("service") String service,
			...
			@RequestParam("mapping") String mapping, @RequestParam("src_data") String srcData,
			@RequestParam("src_fmt") String srcFmt, @RequestParam("tgt_fmt") String tgtFmt) throws Exception {
